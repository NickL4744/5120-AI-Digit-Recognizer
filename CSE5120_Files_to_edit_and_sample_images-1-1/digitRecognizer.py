...
from keras.utils import np_utils, to_categorical # This will be used to convert your test image to a categorical class (digit from 0 to 9)
...
model.fit(X_train, y_train, epochs=15, batch_size=150, validation_data=(X_test, y_test))
